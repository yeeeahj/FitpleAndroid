...
/*    public void selectedPie(int index){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(PieHelper pieHelper : pieHelperList){
            ...
            canvas.drawArc(whiteRect ,0,360,true,cirWhite);
 ...
 /*   @Override
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        cirRect.set(pieCenterPoint.x-pieRadius,
                ...
                pieCenterPoint.y+pieRadius);
        whiteRect.set(pieCenterPoint.x-pieRadius+15,
                pieCenterPoint.y-pieRadius+15,
                pieCenterPoint.x+pieRadius-15,
                pieCenterPoint.y+pieRadius-15);
